...
//		CCLOG(@"Retina Display Not supported");
	...
	[[SKPaymentQueue defaultQueue] addTransactionObserver:[FTIAPHelper sharedHelper]];
	// Removes the startup flicker
	[self removeStartupFlicker];
	[viewController initStatusFile];
	// Run the intro Scene
...
-(void)displayIAd{
    //NSLog(@"in appdelegaute");
    [viewController addBannerView];
